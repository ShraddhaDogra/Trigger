...
-- Module  Version: 6.5
--/d/jspc29/lattice/diamond/3.5_x64/ispfpga/bin/lin64/scuba -w -n ram_18x256_oreg -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type bram -wp 10 -rp 0011 -rdata_width 18 -data_width 18 -num_rows 256 -outdata REGISTERED -cascade -1 

-- Thu Jul  9 14:23:59 2015
...
architecture Structure of ram_18x256_oreg is
    ...
    attribute MEM_LPC_FILE of ram_18x256_oreg_0_0_0 : label is "ram_18x256_oreg.lpc";
    attribute MEM_INIT_FILE of ram_18x256_oreg_0_0_0 : label is "";
    attribute RESETMODE of ram_18x256_oreg_0_0_0 : label is "SYNC";
...
begin
    ...
    ram_18x256_oreg_0_0_0: DP16KC
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            ...
            CEA=>WrClockEn, CLKA=>WrClock, OCEA=>WrClockEn, WEA=>WE, 
            ...
            ADB11=>RdAddress(7), ADB12=>scuba_vlo, ADB13=>scuba_vlo, 
            CEB=>RdClockEn, CLKB=>RdClock, OCEB=>RdClockEn, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of ram_18x256_oreg is
    for Structure
