...
-- Module  Version: 5.4
--/opt/lattice/ispLEVER8.0/isptools/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5m00 -type ebfifo -pfu_fifo -depth 16 -width 18 -depth 16 -rdata_width 18 -no_enable -pe -1 -pf 7 -e 

-- Tue Oct  5 12:24:19 2010
...
entity lattice_ecp2m_fifo_18x16_dualport is
    port (
...
end lattice_ecp2m_fifo_18x16_dualport;

architecture Structure of lattice_ecp2m_fifo_18x16_dualport is
...
-- synopsys translate_off
library ecp2m;
configuration Structure_CON of lattice_ecp2m_fifo_18x16_dualport is
    for Structure
