...
-- Module  Version: 5.1
--/opt/lattice/ispLEVER8.0/isptools/ispfpga/bin/lin/scuba -w -n pll_in200_out100 -lang vhdl -synth synplify -arch ep5m00 -type pll -fin 200 -phase_cntl STATIC -fclkop 100 -fclkop_tol 0.0 -delay_cntl AUTO_NO_DELAY -fb_mode CLOCKTREE -extcap DISABLED -noclkos -noclkok -norst -e 

-- Fri Dec 18 18:26:57 2009
...
architecture Structure of pll_in200_out100 is
    ...
    attribute FREQUENCY_PIN_CLKI of PLLDInst_0 : label is "200.000000";
    attribute CLKOP_DIV of PLLDInst_0 : label is "8";
    attribute CLKFB_DIV of PLLDInst_0 : label is "1";
    attribute CLKI_DIV of PLLDInst_0 : label is "2";
    attribute FIN of PLLDInst_0 : label is "200.000000";
