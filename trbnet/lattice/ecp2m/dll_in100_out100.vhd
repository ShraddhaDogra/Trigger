...
-- Module  Version: 3.4
--/opt/lattice/ispLEVER7.2/isptools/ispfpga/bin/lin/scuba -w -n dll_in100_out100 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5m00 -type dll -dll_type cid -fin 100 -clkos_div 1 -fb_mode 0 -e 

-- Mon Jul  6 16:50:53 2009
...
entity dll_in100_out100 is
 ...
 attribute dont_touch of dll_in100_out100 : entity is "true";
end dll_in100_out100;

architecture Structure of dll_in100_out100 is
    ...
    attribute FREQUENCY_PIN_CLKOS of dll_in100_out100_0_0 : label is "100.000000";
    attribute FREQUENCY_PIN_CLKOP of dll_in100_out100_0_0 : label is "100.000000";
    attribute FREQUENCY_PIN_CLKI of dll_in100_out100_0_0 : label is "100.000000";
    attribute GSR of dll_in100_out100_0_0 : label is "DISABLED";
    attribute CLKFB_PDEL of dll_in100_out100_0_0 : label is "DEL0";
    attribute CLKI_PDEL of dll_in100_out100_0_0 : label is "DEL0";
    attribute ALU_INIT_CNTVAL of dll_in100_out100_0_0 : label is "0";
    attribute ALU_UNLOCK_CNT of dll_in100_out100_0_0 : label is "3";
    attribute ALU_LOCK_CNT of dll_in100_out100_0_0 : label is "3";
    attribute CLKI_DIV of dll_in100_out100_0_0 : label is "1";
    attribute CLKOS_DIV of dll_in100_out100_0_0 : label is "1";
    attribute CLKOS_FPHASE of dll_in100_out100_0_0 : label is "0";
    attribute CLKOS_PHASE of dll_in100_out100_0_0 : label is "270";
    attribute CLKOP_PHASE of dll_in100_out100_0_0 : label is "270";
...
-- synopsys translate_off
library ecp2m;
configuration Structure_CON of dll_in100_out100 is
    for Structure
