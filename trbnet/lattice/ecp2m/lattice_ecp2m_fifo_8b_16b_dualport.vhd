...
-- Module  Version: 5.4
--X:\Programme\ispTOOLS_80\ispfpga\bin\nt\scuba.exe -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5m00 -type ebfifo -depth 512 -width 8 -depth 512 -rdata_width 16 -no_enable -pe -1 -pf -1 -rfill -fill -e 

-- Thu Jul 08 12:01:16 2010
...
entity lattice_ecp2m_fifo_8b_16b_dualport is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end lattice_ecp2m_fifo_8b_16b_dualport;

architecture Structure of lattice_ecp2m_fifo_8b_16b_dualport is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "lattice_ecp2m_fifo_8b_16b_dualport.lpc";
...
begin
    ...
    pdp_ram_0_0_0: DP16KB
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            ...
            ADB10=>rptr_6, ADB11=>rptr_7, ADB12=>scuba_vlo, 
            ...
            DOB4=>Q(4), DOB5=>Q(5), DOB6=>Q(6), DOB7=>Q(7), DOB8=>open, 
            DOB9=>Q(8), DOB10=>Q(9), DOB11=>Q(10), DOB12=>Q(11), 
            DOB13=>Q(12), DOB14=>Q(13), DOB15=>Q(14), DOB16=>Q(15), 
            DOB17=>open);
...
-- synopsys translate_off
library ecp2m;
configuration Structure_CON of lattice_ecp2m_fifo_8b_16b_dualport is
    for Structure
