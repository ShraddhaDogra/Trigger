...
-- Module  Version: 4.7
--/opt/lattice/ispLEVER8.0/isptools/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5m00 -type ebfifo -depth 256 -width 18 -depth 256 -regout -no_enable -pe -1 -pf 0 -fill -e 

-- Wed Mar 31 18:15:58 2010
...
begin
    ...
    pdp_ram_0_0_0: DP16KB
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            ...
            ADB13=>scuba_vlo, CEB=>scuba_vhi, CLKB=>Clock, 
