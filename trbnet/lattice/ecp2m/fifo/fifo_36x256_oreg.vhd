...
-- Module  Version: 4.7
--/opt/lattice/ispLEVER8.0/isptools/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5m00 -type ebfifo -depth 256 -width 36 -depth 256 -regout -no_enable -pe -1 -pf 0 -fill -e 

-- Wed Mar 31 11:37:37 2010
...
begin
    ...
    wcnt_4: FSUB2B
        port map (A0=>wcount_7, A1=>wcnt_sub_msb, B0=>rptr_7, 
            B1=>scuba_vlo, BI=>co3_5, BOUT=>co4_3, S0=>wcnt_sub_7, 
            S1=>wcnt_sub_8);
