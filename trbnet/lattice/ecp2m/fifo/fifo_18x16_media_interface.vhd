...
-- Module  Version: 4.8
--/opt/lattice/ispLEVER8.0/isptools/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5m00 -type ebfifo -pfu_fifo -depth 16 -width 18 -depth 16 -no_enable -pe 5 -pf -1 -fill -e 

-- Tue Jun  1 12:13:00 2010
...
entity fifo_18x16_media_interface is
    port (
...
end fifo_18x16_media_interface;

architecture Structure of fifo_18x16_media_interface is
...
begin
    ...
    fifo_pfu_0_0: DPR16X4A
        port map (DI0=>Data(16), DI1=>Data(17), DI2=>scuba_vlo, 
            ...
            WAD3=>wcount_3, DO0=>rdataout16, DO1=>rdataout17, DO2=>open, 
            DO3=>open);
...
-- synopsys translate_off
library ecp2m;
configuration Structure_CON of fifo_18x16_media_interface is
    for Structure
