...
-- Module  Version: 4.7
--/opt/lattice/ispLEVER8.0/isptools/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5m00 -type ebfifo -depth 1024 -width 36 -depth 1024 -regout -no_enable -pe -1 -pf 0 -fill -e 

-- Wed Mar 31 11:37:00 2010
...
architecture Structure of fifo_36x1k_oreg is
    ...
    attribute CSDECODE_B of pdp_ram_0_0_1 : label is "0b001";
    ...
    attribute REGMODE_B of pdp_ram_0_0_1 : label is "OUTREG";
    attribute REGMODE_A of pdp_ram_0_0_1 : label is "OUTREG";
    attribute DATA_WIDTH_B of pdp_ram_0_0_1 : label is "18";
    attribute DATA_WIDTH_A of pdp_ram_0_0_1 : label is "18";
    attribute MEM_LPC_FILE of pdp_ram_0_1_0 : label is "fifo_36x1k_oreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_0 : label is "";
    attribute CSDECODE_B of pdp_ram_0_1_0 : label is "0b001";
    ...
    attribute REGMODE_B of pdp_ram_0_1_0 : label is "OUTREG";
    attribute REGMODE_A of pdp_ram_0_1_0 : label is "OUTREG";
    attribute DATA_WIDTH_B of pdp_ram_0_1_0 : label is "18";
    attribute DATA_WIDTH_A of pdp_ram_0_1_0 : label is "18";
...
begin
    ...
    pdp_ram_0_0_1: DP16KB
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            ...
            ADB11=>rptr_7, ADB12=>rptr_8, ADB13=>rptr_9, CEB=>scuba_vhi, 
    ...
    wcnt_5: FSUB2B
        port map (A0=>wcount_9, A1=>wcnt_sub_msb, B0=>rptr_9, 
            B1=>scuba_vlo, BI=>co4_5, BOUT=>co5_3, S0=>wcnt_sub_9, 
            S1=>wcnt_sub_10);

    wcntd: FADD2B
        port map (A0=>scuba_vlo, A1=>scuba_vlo, B0=>scuba_vlo, 
            B1=>scuba_vlo, CI=>co5_3, COUT=>open, S0=>co5_3d, S1=>open);
...
-- synopsys translate_off
library ecp2m;
configuration Structure_CON of fifo_36x1k_oreg is
    for Structure
