...
-- Module  Version: 4.2
--/opt/lattice/isplever7.0/isptools/ispfpga/bin/lin/scuba -w -n lattice_scm_fifo_18x16 -lang vhdl -synth synplify -bus_exp 7 -bb -arch or5s00 -type ebfifo -depth 16 -width 18 -rwidth 18 -pfu_fifo -no_enable -pe -1 -pf -1 -sync_reset -e 

-- Fri Feb  8 13:39:45 2008
...
entity lattice_scm_fifo_18x16 is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end lattice_scm_fifo_18x16;

architecture Structure of lattice_scm_fifo_18x16 is
...
begin
    ...
    w_gctr_2: CU2
        port map (CI=>co1, PC1=>scuba_vlo, PC0=>wcount_4, CO=>co2, 
    ...
    r_gctr_2: CU2
        port map (CI=>co1_1, PC1=>scuba_vlo, PC0=>rcount_4, CO=>co2_1, 
            NC1=>open, NC0=>ircount_4);

    empty_cmp_0: AGEB2
        port map (A1=>rcount_1, A0=>rcount_0, B1=>w_g2b_xor_cluster_0, 
    ...
    empty_cmp_2: AGEB2
        port map (A1=>scuba_vlo, A0=>empty_cmp_set, B1=>scuba_vlo, 
            B0=>empty_cmp_clr, CI=>co1_2, GE=>empty_d_c);
    ...
    full_cmp_0: AGEB2
        port map (A1=>wcount_1, A0=>wcount_0, B1=>r_g2b_xor_cluster_0, 
    ...
    full_cmp_2: AGEB2
        port map (A1=>scuba_vlo, A0=>full_cmp_set, B1=>scuba_vlo, 
            B0=>full_cmp_clr, CI=>co1_3, GE=>full_d_c);
...
-- synopsys translate_off
library SCM;
configuration Structure_CON of lattice_scm_fifo_18x16 is
    for Structure
