...
entity PCSA is
GENERIC(
  CONFIG_FILE : String  := "serdes_gbe_0.txt"
  );
port (
  HDINP0            : in std_logic;
  HDINN0            : in std_logic;
...
entity serdes_gbe_0 is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_gbe_0.txt");
 port (
-- serdes clk pins --
...
architecture serdes_gbe_0_arch of serdes_gbe_0 is
