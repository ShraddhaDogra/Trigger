...
entity PCSC is
GENERIC(
  CONFIG_FILE : String  := "serdes_gbe_0_200.txt"
  );
port (
  HDINN0             : in std_logic;
  HDINN1             : in std_logic;
...
entity serdes_gbe_0_200 is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_gbe_0_200.txt");
 port (
...
end serdes_gbe_0_200;

architecture serdes_gbe_0_200_arch of serdes_gbe_0_200 is
