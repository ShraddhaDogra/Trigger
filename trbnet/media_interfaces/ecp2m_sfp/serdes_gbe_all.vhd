...
entity PCSC is
GENERIC(
  CONFIG_FILE : String  := "serdes_gbe_all.txt"
  );
port (
  HDINN0             : in std_logic;
  HDINN1             : in std_logic;
...
entity serdes_gbe_all is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_gbe_all.txt");
 port (
...
architecture serdes_gbe_all_arch of serdes_gbe_all is
