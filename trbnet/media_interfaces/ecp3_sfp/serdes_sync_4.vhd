...
GENERIC(
  ...
  PLL_SRC   : String
--  CONFIG_FILE : String  := "serdes_sync_4.txt";
...
entity serdes_sync_4 is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_sync_4.txt");
 port (
------------------
-- CH0 --
...
architecture serdes_sync_4_arch of serdes_sync_4 is
