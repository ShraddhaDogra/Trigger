...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n Cpll -lang verilog -synth synplify -arch ep5c00 -type pll -fin 200 -phase_cntl DYNAMIC -mdiv 4 -ndiv 1 -vdiv 16 -fb_mode CLOCKTREE -duty50 -kdiv 2 -clkoki 0 -norst -noclkok2 -bw  */
/* Tue Jul 17 05:46:20 2018 */


`timescale 1 ns / 1 ps
module Cpll (CLK, FINEDELB0, FINEDELB1, FINEDELB2, FINEDELB3, DPHASE0, 
    DPHASE1, DPHASE2, DPHASE3, CLKOP, CLKOS, CLKOK, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLK;
