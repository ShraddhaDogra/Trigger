...
-- Module  Version: 5.7
--C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_in200_out100 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 50.63 -phase_cntl STATIC -fclkop 200 -fclkop_tol 1.0 -fb_mode INTERNAL -noclkos -fclkok 100 -fclkok_tol 0.5 -clkoki 0 -use_rst -noclkok2 -bw 

-- Mon Dec 03 04:48:32 2018
...
architecture Structure of pll_in200_out100 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "199.355625";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "50.630000";
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "99.677813";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  4, CLKFB_DIV=>  63, CLKI_DIV=>  16, 
        FIN=> "50.630000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_in200_out100 is
    for Structure
