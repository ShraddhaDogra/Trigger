...
; End EBR Section
; Begin PLL Section
Instance_Name = PID_TRIG/TDC/CG/P2Clk/PLLInst_0;
Type = EHXPLLF;
...
Instance_Name = PID_TRIG/TDC/CG/P1Clk/PLLInst_0;
Type = EHXPLLF;
...
CLKOS_Duty_Trim_Polarity = RISING;
CLKOS_Duty_Trim_Polarity_Delay_(ps) = 0;
Instance_Name = PID_TRIG/TDC/CG/PClk/PLLInst_0;
Type = EHXPLLF;
...
Type = EHXPLLF;
Output_Clock(P)_Actual_Frequency = 199.3556;
CLKOP_BYPASS = DISABLED;
CLKOS_BYPASS = DISABLED;
CLKOK_BYPASS = DISABLED;
CLKOK_Input = CLKOP;
