...
/* Module Version: 5.7 */
/* D:\Cad\lscc39\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n Cpll0 -lang verilog -synth synplify -arch ep5c00 -type pll -fin 50 -phase_cntl DYNAMIC -mdiv 1 -ndiv 8 -vdiv 2 -fb_mode CLOCKTREE -kdiv 4 -clkoki 0 -rstk -norst -noclkok2 -bw  */
/* Thu Apr 06 12:07:52 2017 */


`timescale 1 ns / 1 ps
module Cpll0 (CLK, RSTK, FINEDELB0, FINEDELB1, FINEDELB2, FINEDELB3, 
    DPHASE0, DPHASE1, DPHASE2, DPHASE3, DDUTY0, DDUTY1, DDUTY2, DDUTY3, 
    CLKOP, CLKOS, CLKOK, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLK;
    input wire RSTK;
