...
entity PCSA is
GENERIC(
  CONFIG_FILE : String  := "trb_net16_med_scm_scp_gbe_0.txt"
  );
port (
  HDINP0            : in std_logic;
  HDINN0            : in std_logic;
...
entity trb_net16_med_scm_scp_gbe_0 is
   GENERIC (USER_CONFIG_FILE    :  String := "trb_net16_med_scm_scp_gbe_0.txt");
 port (
-- serdes clk pins --
...
end trb_net16_med_scm_scp_gbe_0;

architecture trb_net16_med_scm_scp_gbe_0_arch of trb_net16_med_scm_scp_gbe_0 is
...
end trb_net16_med_scm_scp_gbe_0_arch ;
