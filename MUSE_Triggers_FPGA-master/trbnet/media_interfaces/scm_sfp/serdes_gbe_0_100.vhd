...
entity PCSA is
GENERIC(
  CONFIG_FILE : String  := "serdes_gbe_0_100.txt"
  );
port (
  HDINP0            : in std_logic;
  HDINN0            : in std_logic;
...
entity serdes_gbe_0_100 is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_gbe_0_100.txt");
 port (
-- serdes clk pins --
...
end serdes_gbe_0_100;

architecture serdes_gbe_0_100_arch of serdes_gbe_0_100 is
