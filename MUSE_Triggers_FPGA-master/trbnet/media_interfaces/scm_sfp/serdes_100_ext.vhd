...
entity PCSA is
GENERIC(
  CONFIG_FILE : String  := "serdes_100_ext.txt"
  );
port (
  HDINP0            : in std_logic;
  HDINN0            : in std_logic;
...
entity serdes_100_ext is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_100_ext.txt");
 port (
-- serdes clk pins --
...
architecture serdes_100_ext_arch of serdes_100_ext is
