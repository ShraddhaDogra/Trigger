...
entity PCSC is
GENERIC(
  CONFIG_FILE : String  := "serdes_gbe_0_200_ext.txt"
  );
port (
  HDINN0             : in std_logic;
  HDINN1             : in std_logic;
...
entity serdes_gbe_0_200_ext is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_gbe_0_200_ext.txt");
 port (
...
end serdes_gbe_0_200_ext;

architecture serdes_gbe_0_200_ext_arch of serdes_gbe_0_200_ext is
...
port (
  ...
  FFS_TXFBFIFO_ERROR_3             : out std_logic
   ...
   attribute FREQUENCY_PIN_FF_RX_F_CLK_0 of PCSC_INST : label is "100";
   attribute FREQUENCY_PIN_FF_RX_F_CLK_1: string;
   attribute FREQUENCY_PIN_FF_RX_F_CLK_1 of PCSC_INST : label is "100";
   attribute FREQUENCY_PIN_FF_RX_F_CLK_2: string;
   attribute FREQUENCY_PIN_FF_RX_F_CLK_2 of PCSC_INST : label is "100";
   attribute FREQUENCY_PIN_FF_RX_F_CLK_3: string;
   attribute FREQUENCY_PIN_FF_RX_F_CLK_3 of PCSC_INST : label is "100";
   attribute FREQUENCY_PIN_FF_RX_H_CLK_0: string;
   attribute FREQUENCY_PIN_FF_RX_H_CLK_0 of PCSC_INST : label is "100.0";
   attribute FREQUENCY_PIN_FF_RX_H_CLK_1: string;
   attribute FREQUENCY_PIN_FF_RX_H_CLK_1 of PCSC_INST : label is "100.0";
   attribute FREQUENCY_PIN_FF_RX_H_CLK_2: string;
   attribute FREQUENCY_PIN_FF_RX_H_CLK_2 of PCSC_INST : label is "100.0";
   attribute FREQUENCY_PIN_FF_RX_H_CLK_3: string;
   attribute FREQUENCY_PIN_FF_RX_H_CLK_3 of PCSC_INST : label is "100.0";
   attribute FREQUENCY_PIN_FF_TX_F_CLK: string;
   attribute FREQUENCY_PIN_FF_TX_F_CLK of PCSC_INST : label is "100";
   attribute FREQUENCY_PIN_FF_TX_H_CLK: string;
   attribute FREQUENCY_PIN_FF_TX_H_CLK of PCSC_INST : label is "100.0"; 
