...
entity PCSC is
GENERIC(
  CONFIG_FILE : String  := "serdes_gbe_0_extclock.txt"
  );
port (
  HDINN0             : in std_logic;
  HDINN1             : in std_logic;
...
entity serdes_gbe_0_extclock is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_gbe_0_extclock.txt");
 port (
...
end serdes_gbe_0_extclock;

architecture serdes_gbe_0_extclock_arch of serdes_gbe_0_extclock is
...
end serdes_gbe_0_extclock_arch ;
