...
entity PCSC is
GENERIC(
  CONFIG_FILE : String  := "serdes_gbe_3.txt"
  );
port (
  HDINN0             : in std_logic;
  HDINN1             : in std_logic;
...
entity serdes_gbe_3 is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_gbe_3.txt");
 port (
...
architecture serdes_gbe_3_arch of serdes_gbe_3 is
