...
-- Module  Version: 5.4
--/d/sugar/lattice/diamond/1.1/ispfpga/bin/lin/scuba -w -n lattice_scm_fifo_16bit_dualport -lang vhdl -synth synplify -bus_exp 7 -bb -arch or5s00 -type ebfifo -depth 64 -width 18 -rwidth 18 -no_enable -pe 10 -pf 32 -sync_reset -e 
...
entity lattice_scm_fifo_16bit_dualport is
    port (
...
end lattice_scm_fifo_16bit_dualport;
...
architecture Structure of lattice_scm_fifo_16bit_dualport is
    ...
    attribute FULLPOINTER1 of lattice_scm_fifo_16bit_dualport_0_0 : label is "0b000011111000001";
    attribute FULLPOINTER of lattice_scm_fifo_16bit_dualport_0_0 : label is "0b000011111100001";
    attribute AFPOINTER1 of lattice_scm_fifo_16bit_dualport_0_0 : label is "0b000001111000001";
    attribute AFPOINTER of lattice_scm_fifo_16bit_dualport_0_0 : label is "0b000001111100001";
    attribute AEPOINTER1 of lattice_scm_fifo_16bit_dualport_0_0 : label is "0b000000101111111";
    attribute AEPOINTER of lattice_scm_fifo_16bit_dualport_0_0 : label is "0b000000101011111";
    ...
    attribute DATA_WIDTH_R of lattice_scm_fifo_16bit_dualport_0_0 : label is "36";
    attribute DATA_WIDTH_W of lattice_scm_fifo_16bit_dualport_0_0 : label is "36";
...
begin
    ...
    lattice_scm_fifo_16bit_dualport_0_0: FIFO16KA
        -- synopsys translate_off
        generic map (FULLPOINTER1=> "000011111000001", FULLPOINTER=> "000011111100001", 
        AFPOINTER1=> "000001111000001", AFPOINTER=> "000001111100001", 
...
-- synopsys translate_off
library SCM;
configuration Structure_CON of lattice_scm_fifo_16bit_dualport is
    for Structure
