...
-- Module  Version: 5.2
--/d/sugar/lattice/diamond/1.1/ispfpga/bin/lin/scuba -w -n pll_in100_out150 -lang vhdl -synth synplify -bus_exp 7 -bb -arch or5s00 -type pll -fin 100 -mfreq 150 -nfreq 100 -bypasss -clkos_fdel 0 -fb 1 -clki_del 0 -clki_fdel 0 -clkfb_del 0 -clkfb_fdel 0 -mtol 0.0 -ntol 0.0 -bw LOW -e 

-- Fri Jan  7 18:19:56 2011
...
entity pll_in100_out150 is
 ...
 attribute dont_touch of pll_in100_out150 : entity is true;
end pll_in100_out150;

architecture Structure of pll_in100_out150 is
    ...
    attribute ip_type of pll_in100_out150_0_0 : label is "EHXPLLA";
    attribute FREQUENCY_PIN_CLKOS of pll_in100_out150_0_0 : label is "100.000000";
    attribute FREQUENCY_PIN_CLKOP of pll_in100_out150_0_0 : label is "150.000000";
    attribute FREQUENCY_PIN_CLKI of pll_in100_out150_0_0 : label is "100.000000";
    attribute VCO_LOWERFREQ of pll_in100_out150_0_0 : label is "DISABLED";
    attribute GMCFREQSEL of pll_in100_out150_0_0 : label is "HIGH";
    attribute GSR of pll_in100_out150_0_0 : label is "ENABLED";
    attribute SPREAD_DIV2 of pll_in100_out150_0_0 : label is "2";
    attribute SPREAD_DIV1 of pll_in100_out150_0_0 : label is "2";
    attribute SPREAD_DRIFT of pll_in100_out150_0_0 : label is "1";
    attribute SPREAD of pll_in100_out150_0_0 : label is "DISABLED";
    attribute CLKFB_FDEL of pll_in100_out150_0_0 : label is "0";
    attribute CLKI_FDEL of pll_in100_out150_0_0 : label is "0";
    attribute CLKFB_PDEL of pll_in100_out150_0_0 : label is "DEL0";
    attribute CLKI_PDEL of pll_in100_out150_0_0 : label is "DEL0";
    attribute LF_RESISTOR of pll_in100_out150_0_0 : label is "0b111001";
    attribute LF_IX5UA of pll_in100_out150_0_0 : label is "31";
    attribute CLKOS_FDEL of pll_in100_out150_0_0 : label is "0";
    attribute CLKOS_VCODEL of pll_in100_out150_0_0 : label is "0";
    attribute PHASEADJ of pll_in100_out150_0_0 : label is "0";
    attribute CLKOS_MODE of pll_in100_out150_0_0 : label is "BYPASS";
    attribute CLKOP_MODE of pll_in100_out150_0_0 : label is "DIV";
    attribute CLKOS_DIV of pll_in100_out150_0_0 : label is "3";
    attribute CLKOP_DIV of pll_in100_out150_0_0 : label is "3";
    attribute CLKFB_DIV of pll_in100_out150_0_0 : label is "3";
    attribute CLKI_DIV of pll_in100_out150_0_0 : label is "2";
...
begin
    ...
    pll_in100_out150_0_0: EHXPLLA
        ...
        CLKOP_MODE=> "DIV", CLKOS_DIV=>  3, CLKOP_DIV=>  3, CLKFB_DIV=>  3, 
        CLKI_DIV=>  2
        -- synopsys translate_on
                     )
...
-- synopsys translate_off
library SCM;
configuration Structure_CON of pll_in100_out150 is
    for Structure
