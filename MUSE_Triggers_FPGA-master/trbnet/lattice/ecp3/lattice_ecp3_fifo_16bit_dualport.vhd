...
-- Module  Version: 5.4
--/d/sugar/lattice/diamond/1.3/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 32 -width 18 -depth 32 -rdata_width 18 -no_enable -pe -1 -pf 16 -e 
...
begin
    ...
    pdp_ram_0_0_0: DP16KC
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            ...
            ADA6=>wptr_2, ADA7=>wptr_3, ADA8=>wptr_4, ADA9=>scuba_vlo, 
            ...
            ADB8=>rptr_4, ADB9=>scuba_vlo, ADB10=>scuba_vlo, 
