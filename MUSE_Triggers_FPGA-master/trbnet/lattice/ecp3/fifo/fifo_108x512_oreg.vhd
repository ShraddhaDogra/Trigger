...
-- Module  Version: 5.0
--/d/jspc29/lattice/diamond/3.4_x64/ispfpga/bin/lin64/scuba -w -n fifo_108x512_oreg -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 512 -width 108 -depth 512 -regout -no_enable -pe -1 -pf 0 -fill 

-- Fri Mar  6 17:34:39 2015
...
end fifo_108x512_oreg;

architecture Structure of fifo_108x512_oreg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_2 : label is "fifo_108x512_oreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_2 : label is "";
    attribute RESETMODE of pdp_ram_0_0_2 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_1_1 : label is "fifo_108x512_oreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_1 : label is "";
    attribute RESETMODE of pdp_ram_0_1_1 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_2_0 : label is "fifo_108x512_oreg.lpc";
...
begin
    ...
    pdp_ram_0_2_0: PDPW16KC
        ...
        port map (DI0=>Data(72), DI1=>Data(73), DI2=>Data(74), 
            ...
            DI26=>Data(98), DI27=>Data(99), DI28=>Data(100), 
            DI29=>Data(101), DI30=>Data(102), DI31=>Data(103), 
            DI32=>Data(104), DI33=>Data(105), DI34=>Data(106), 
            DI35=>Data(107), ADW0=>wptr_0, ADW1=>wptr_1, ADW2=>wptr_2, 
            ADW3=>wptr_3, ADW4=>wptr_4, ADW5=>wptr_5, ADW6=>wptr_6, 
            ADW7=>wptr_7, ADW8=>wptr_8, BE0=>scuba_vhi, BE1=>scuba_vhi, 
            BE2=>scuba_vhi, BE3=>scuba_vhi, CEW=>wren_i, CLKW=>Clock, 
            CSW0=>scuba_vhi, CSW1=>scuba_vlo, CSW2=>scuba_vlo, 
            ...
            DO9=>Q(99), DO10=>Q(100), DO11=>Q(101), DO12=>Q(102), 
            DO13=>Q(103), DO14=>Q(104), DO15=>Q(105), DO16=>Q(106), 
            DO17=>Q(107), DO18=>Q(72), DO19=>Q(73), DO20=>Q(74), 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of fifo_108x512_oreg is
    for Structure
