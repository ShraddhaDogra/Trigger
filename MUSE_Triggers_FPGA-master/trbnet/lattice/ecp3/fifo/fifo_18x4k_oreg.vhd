...
-- Module  Version: 5.0
--/d/jspc29/lattice/diamond/3.4_x64/ispfpga/bin/lin64/scuba -w -n fifo_18x4k_oreg -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 4096 -width 18 -depth 4096 -regout -no_enable -pe -1 -pf 0 -fill 

-- Fri Mar  6 17:36:53 2015
...
architecture Structure of fifo_18x4k_oreg is
...
begin
    ...
    pdp_ram_0_1_2: DP16KC
        ...
        port map (DIA0=>Data(9), DIA1=>Data(10), DIA2=>Data(11), 
            ...
            CLKB=>Clock, OCEB=>scuba_vhi, WEB=>scuba_vlo, CSB0=>rptr_11, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of fifo_18x4k_oreg is
    for Structure
