...
-- Module  Version: 4.8
--/d/sugar/lattice/diamond/1.3/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 256 -width 18 -depth 256 -regout -no_enable -pe -1 -pf 0 -fill -e 

-- Mon Sep 12 17:42:28 2011
...
begin
    ...
    pdp_ram_0_0_0: DP16KC
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            ...
            ADA10=>wptr_6, ADA11=>wptr_7, ADA12=>scuba_vlo, 
            ADA13=>scuba_vlo, CEA=>wren_i, CLKA=>Clock, OCEA=>wren_i, 
            ...
            ADB12=>scuba_vlo, ADB13=>scuba_vlo, CEB=>rden_i, CLKB=>Clock, 
