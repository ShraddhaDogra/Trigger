...
-- Module  Version: 5.0
--/d/sugar/lattice/ispLever7.2/isptools/ispfpga/bin/lin/scuba -w -n pll_100 -lang vhdl -synth synplify -arch ep5m00 -type pll -fin 100 -phase_cntl STATIC -fclkop 100 -fclkop_tol 0.0 -delay_cntl AUTO_NO_DELAY -fb_mode CLOCKTREE -extcap DISABLED -noclkos -noclkok -norst -e 

-- Mon Jul  6 13:45:53 2009
...
entity pll_100 is
 ...
 attribute dont_touch of pll_100 : entity is "true";
end pll_100;

architecture Structure of pll_100 is
...
-- synopsys translate_off
library ecp2m;
configuration Structure_CON of pll_100 is
    for Structure
