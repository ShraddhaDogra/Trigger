...
-- Module  Version: 3.5
--/opt/lattice/ispLEVER8.0/isptools/ispfpga/bin/lin/scuba -w -n dll_in200_out100 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5m00 -type dll -dll_type cid -fin 200 -clkos_div 2 -fb_mode 0 -e 

-- Fri Dec 18 17:54:30 2009
...
entity dll_in200_out100 is
 ...
 attribute dont_touch of dll_in200_out100 : entity is true;
end dll_in200_out100;

architecture Structure of dll_in200_out100 is
    ...
    attribute FREQUENCY_PIN_CLKOS of dll_in200_out100_0_0 : label is "100.000000";
    attribute FREQUENCY_PIN_CLKOP of dll_in200_out100_0_0 : label is "200.000000";
    attribute FREQUENCY_PIN_CLKI of dll_in200_out100_0_0 : label is "200.000000";
    attribute GSR of dll_in200_out100_0_0 : label is "DISABLED";
    attribute CLKFB_PDEL of dll_in200_out100_0_0 : label is "DEL0";
    attribute CLKI_PDEL of dll_in200_out100_0_0 : label is "DEL0";
    attribute ALU_INIT_CNTVAL of dll_in200_out100_0_0 : label is "0";
    attribute ALU_UNLOCK_CNT of dll_in200_out100_0_0 : label is "3";
    attribute ALU_LOCK_CNT of dll_in200_out100_0_0 : label is "3";
    attribute CLKI_DIV of dll_in200_out100_0_0 : label is "1";
    attribute CLKOS_DIV of dll_in200_out100_0_0 : label is "2";
    attribute CLKOS_FPHASE of dll_in200_out100_0_0 : label is "0";
    attribute CLKOS_PHASE of dll_in200_out100_0_0 : label is "180";
    attribute CLKOP_PHASE of dll_in200_out100_0_0 : label is "180";
...
begin
    ...
    dll_in200_out100_0_0: CIDDLLA
        -- synopsys translate_off
        generic map (GSR=> "DISABLED", ALU_INIT_CNTVAL=>  0, 
        ALU_UNLOCK_CNT=>  3, ALU_LOCK_CNT=>  3, CLKI_DIV=>  1, CLKOS_DIV=>  2, 
        CLKOS_FPHASE=>  0, CLKOS_PHASE=>  180, CLKOP_PHASE=>  180)
        -- synopsys translate_on
...
-- synopsys translate_off
library ecp2m;
configuration Structure_CON of dll_in200_out100 is
    for Structure
