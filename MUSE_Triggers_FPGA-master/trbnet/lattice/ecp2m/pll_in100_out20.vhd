...
-- Module  Version: 5.1
--/opt/lattice/ispLEVER8.0/isptools/ispfpga/bin/lin/scuba -w -n pll_in100_out20 -lang vhdl -synth synplify -arch ep5m00 -type pll -fin 100 -phase_cntl STATIC -fclkop 20 -fclkop_tol 0.0 -delay_cntl AUTO_NO_DELAY -fb_mode CLOCKTREE -extcap AUTO -noclkos -noclkok -norst -e 

-- Mon Feb  8 17:18:55 2010
...
entity pll_in100_out20 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of pll_in100_out20 : entity is true;
end pll_in100_out20;

architecture Structure of pll_in100_out20 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLDInst_0 : label is "20.000000";
    ...
    attribute CLKOP_DIV of PLLDInst_0 : label is "64";
...
begin
    ...
    PLLDInst_0: EPLLD
        ...
        PHASE_CNTL=> "STATIC", DUTY=>  8, PHASEADJ=> "0.0", CLKOP_DIV=>  64, 
        CLKFB_DIV=>  1, CLKI_DIV=>  5)
        -- synopsys translate_on
...
-- synopsys translate_off
library ecp2m;
configuration Structure_CON of pll_in100_out20 is
    for Structure
