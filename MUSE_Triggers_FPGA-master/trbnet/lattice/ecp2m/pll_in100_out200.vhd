...
-- Module  Version: 4.1
--/opt/lattice/ispLEVER7.1/isptools/ispfpga/bin/lin/scuba -w -n pll_in100_out200 -lang vhdl -synth synplify -arch ep5m00 -type pll -fin 100 -phase_cntl STATIC -fclkop 200 -fclkop_tol 0.0 -delay_cntl AUTO_NO_DELAY -fb_mode CLOCKTREE -extcap DISABLED -noclkos -noclkok -norst -e 

-- Wed Apr 15 17:19:06 2009
...
entity pll_in100_out200 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : string;
 attribute dont_touch of pll_in100_out200 : entity is "true";
end pll_in100_out200;

architecture Structure of pll_in100_out200 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLDInst_0 : label is "200.000000";
    ...
    attribute CLKOP_DIV of PLLDInst_0 : label is "4";
...
begin
    ...
    PLLDInst_0: EPLLD
        ...
        PHASE_CNTL=> "STATIC", DUTY=>  8, PHASEADJ=> "0.0", CLKOP_DIV=>  4, 
        CLKFB_DIV=>  2, CLKI_DIV=>  1)
        -- synopsys translate_on
...
-- synopsys translate_off
library ecp2m;
configuration Structure_CON of pll_in100_out200 is
    for Structure
