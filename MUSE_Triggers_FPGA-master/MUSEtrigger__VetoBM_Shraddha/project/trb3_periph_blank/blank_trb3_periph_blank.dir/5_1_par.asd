...
GLOBAL_PRIMARY_2_SIGNALNAME = THE_MEDIA_UPLINK/ff_rxhalfclk;
GLOBAL_PRIMARY_2_DRIVERTYPE = PCS;
...
GLOBAL_SECONDARY_0_LOADNUM = 295;
GLOBAL_SECONDARY_0_SIGTYPE = RST;
; Global secondary clock #1
GLOBAL_SECONDARY_1_SIGNALNAME = THE_ENDPOINT/THE_HANDLER_TRIGGER_DATA/reset_ipu_i_i_i_o2;
GLOBAL_SECONDARY_1_DRIVERTYPE = SLICE;
GLOBAL_SECONDARY_1_LOADNUM = 121;
...
GLOBAL_SECONDARY_3_SIGNALNAME = CLK_PCLK_RIGHT_c;
GLOBAL_SECONDARY_3_DRIVERTYPE = CLK_PIN;
GLOBAL_SECONDARY_3_LOADNUM = 5;
GLOBAL_SECONDARY_3_SIGTYPE = CLK;
; Global secondary clock #4
GLOBAL_SECONDARY_4_SIGNALNAME = THE_TOOLS/gen_STATISTICS.THE_STAT_LOGIC/reset_cnt_rep1;
GLOBAL_SECONDARY_4_DRIVERTYPE = SLICE;
GLOBAL_SECONDARY_4_LOADNUM = 104;
GLOBAL_SECONDARY_4_SIGTYPE = RST;
; Global secondary clock #5
GLOBAL_SECONDARY_5_SIGNALNAME = THE_TOOLS/gen_STATISTICS.THE_STAT_LOGIC/reset_cnt_fast;
GLOBAL_SECONDARY_5_DRIVERTYPE = SLICE;
GLOBAL_SECONDARY_5_LOADNUM = 104;
