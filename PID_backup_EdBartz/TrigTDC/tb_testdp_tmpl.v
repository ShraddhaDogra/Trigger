//Verilog testbench template generated by SCUBA Diamond (64-bit) 3.7.1.502
`timescale 1 ns / 1 ps
module tb;
    reg [4:0] WrAddress = 5'b0;
    reg [4:0] RdAddress = 5'b0;
    reg [15:0] Data = 16'b0;
    reg WE = 0;
    reg RdClock = 0;
    reg RdClockEn = 0;
    ...
    testdp u1 (.WrAddress(WrAddress), .RdAddress(RdAddress), .Data(Data), 
